  ...
  useEffect(() => {
    const sampleNotifications: Notification[] = [
      ...
      },
      {
        ...
        read: false,
        timestamp: new Date(),
        link: '/devotion', // ✅ Add link for devotion
      },
      {
        id: '3',
        title: ' New Update',
...
useEffect(() => {
  ...
  const handleNotificationClick = (notification: Notification) => {
    ...
    if (notification.link) {
      // If it's an internal link, we could handle it differently
                ...
                >
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {/* ✅ Show "Go to Devotion" badge for devotion notifications */}
